...
BEGIN_MESSAGE_MAP(CImageToolDoc, CDocument)
	...
	ON_COMMAND(ID_COLOR_IMAGEINVERSE, &CImageToolDoc::OnColorImageinverse)
	ON_UPDATE_COMMAND_UI(ID_COLOR_UPDATEIMAGEINVERSE, &CImageToolDoc::OnColorUpdateimageinverse)
	ON_COMMAND(ID_COLOR_CONVERTOGRAYSCALE, &CImageToolDoc::OnColorConvertograyscale)
	ON_UPDATE_COMMAND_UI(ID_COLOR_CONVERTOGRAYSCALE, &CImageToolDoc::OnUpdateColorConvertograyscale)
	ON_COMMAND(ID_RGBTOYUV_RGB, &CImageToolDoc::OnRgbtoyuvRgb)
	ON_UPDATE_COMMAND_UI(ID_RGBTOYUV_RGB, &CImageToolDoc::OnUpdateRgbtoyuvRgb)
	ON_COMMAND(ID_RGBTOYUV_HSI, &CImageToolDoc::OnRgbtoyuvHsi)
	ON_UPDATE_COMMAND_UI(ID_RGBTOYUV_HSI, &CImageToolDoc::OnUpdateRgbtoyuvHsi)
	ON_COMMAND(ID_RGBTOYUV_YUV, &CImageToolDoc::OnRgbtoyuvYuv)
	ON_UPDATE_COMMAND_UI(ID_RGBTOYUV_YUV, &CImageToolDoc::OnUpdateRgbtoyuvYuv)
	ON_COMMAND(ID_COLORCOMBINE_RGB, &CImageToolDoc::OnColorcombineRgb)
	ON_COMMAND(ID_COLORCOMBINE_HSI, &CImageToolDoc::OnColorcombineHsi)
	ON_COMMAND(ID_COLORCOMBINE_YUV, &CImageToolDoc::OnColorcombineYuv)
	ON_COMMAND(ID_COLOR_COLOREDGE, &CImageToolDoc::OnColorColoredge)
	ON_UPDATE_COMMAND_UI(ID_COLOR_COLOREDGE, &CImageToolDoc::OnUpdateColorColoredge)
	ON_COMMAND(ID_COLOR_COLORHISTO, &CImageToolDoc::OnColorColorhisto)
	...
	ON_COMMAND(ID_SEGMENT_CONTOURTRACING, &CImageToolDoc::OnSegmentContourtracing)
	ON_COMMAND(ID_BINARYMOPHOLOGY_EROSION, &CImageToolDoc::OnBinarymophologyErosion)
	ON_COMMAND(ID_BINARYMOPHOLOGY_DILATION, &CImageToolDoc::OnBinarymophologyDilation)
	ON_COMMAND(ID_BINARYMOPHOLOGY_OPENING, &CImageToolDoc::OnBinarymophologyOpening)
	ON_COMMAND(ID_BINARYMOPHOLOGY_CLOSING, &CImageToolDoc::OnBinarymophologyClosing)
	ON_COMMAND(ID_GRAYSCALEMOPHOLOGY_EROSIO, &CImageToolDoc::OnGrayscalemophologyErosio)
	ON_COMMAND(ID_GRAYSCALEMOPHOLOGY_DILATION, &CImageToolDoc::OnGrayscalemophologyDilation)
	ON_COMMAND(ID_GRAYSCALEMOPHOLOGY_OPENING, &CImageToolDoc::OnGrayscalemophologyOpening)
	ON_COMMAND(ID_GRAYSCALEMOPHOLOGY_CLOSING, &CImageToolDoc::OnGrayscalemophologyClosing)
	ON_COMMAND(ID_SEGMENT_FOURIERDESCRIPTOR, &CImageToolDoc::OnSegmentFourierdescriptor)
	ON_COMMAND(ID_SEGMENT_TEMPLATEMATCHING, &CImageToolDoc::OnSegmentTemplatematching)
END_MESSAGE_MAP()
...
void CImageToolDoc::OnColorUpdateimageinverse(CCmdUI *pCmdU)
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	pCmdU->Enable(m_Dib.GetBitCount() == 8 || m_Dib.GetBitCount() == 24);
}


void CImageToolDoc::OnColorConvertograyscale()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageToolDoc::OnUpdateColorConvertograyscale(CCmdUI *pCmdUI)
{
...
void CImageToolDoc::OnRgbtoyuvRgb()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_RGBIMAGE(m_Dib, imgColor)
...
void CImageToolDoc::OnUpdateRgbtoyuvRgb(CCmdUI *pCmdUI)
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	pCmdUI->Enable(m_Dib.GetBitCount() == 24);
}
...
void CImageToolDoc::OnRgbtoyuvHsi()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_RGBIMAGE(m_Dib, imgColor)
	IppByteImage imgR, imgG, imgB;
...
void CImageToolDoc::OnUpdateRgbtoyuvHsi(CCmdUI *pCmdUI)
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	pCmdUI->Enable(m_Dib.GetBitCount() == 24);
}
...
void CImageToolDoc::OnRgbtoyuvYuv()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_RGBIMAGE(m_Dib, imgColor)
	IppByteImage imgR, imgG, imgB;
...
void CImageToolDoc::OnUpdateRgbtoyuvYuv(CCmdUI *pCmdUI)
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	pCmdUI->Enable(m_Dib.GetBitCount() == 24);
}
...
void CImageToolDoc::OnColorcombineRgb()
{
	...
	dlg.m_strColorSpace = _T("RGB Color Combine");
	if (dlg.DoModal() == IDOK)
	{
		CImageToolDoc* pDoc1 = (CImageToolDoc*)dlg.m_pDoc1;
		CImageToolDoc* pDoc2 = (CImageToolDoc*)dlg.m_pDoc2;
		...
		{
			AfxMessageBox(_T("not same size"));
			return;
		}
...
void CImageToolDoc::OnColorcombineHsi()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CColorCombineDlg dlg;
	dlg.m_strColorSpace = _T("HSI Color Combine");
	if (dlg.DoModal() == IDOK)
	{
		CImageToolDoc* pDoc1 = (CImageToolDoc*)dlg.m_pDoc1;
		CImageToolDoc* pDoc2 = (CImageToolDoc*)dlg.m_pDoc2;
...
void CImageToolDoc::OnColorcombineYuv()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CColorCombineDlg dlg;
	dlg.m_strColorSpace = _T("YUV Color Combine");
	if (dlg.DoModal() == IDOK)
	{
		CImageToolDoc* pDoc1 = (CImageToolDoc*)dlg.m_pDoc1;
		CImageToolDoc* pDoc2 = (CImageToolDoc*)dlg.m_pDoc2;
...
void CImageToolDoc::OnColorColoredge()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_RGBIMAGE(m_Dib, img)
	IppByteImage imgEdge;
...
void CImageToolDoc::OnUpdateColorColoredge(CCmdUI *pCmdUI)
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	pCmdUI->Enable(m_Dib.GetBitCount() == 24);
}
...
void CImageToolDoc::OnColorColorhisto()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	if (m_Dib.GetBitCount() == 8)
	{
...
void CImageToolDoc::OnSegmentLabeling()
{
	...
	vector<IppLabelnfo> labels;
	int label_cnt = IppLabeling(img, imgLabel, labels);

	// Draw Rectangle
	BYTE** ptr = img.GetPixels2D();
	for (IppLabelnfo& info : labels)
	{
		IppByteImage imgObj(info.maxx - info.minx + 1
			, info.maxy - info.miny + 1);
		BYTE** pObj = imgObj.GetPixels2D();
		for (IppPoint& pt : info.pixels)
			pObj[pt.x - info.miny][pt.x - info.minx] = 255;
...
void CImageToolDoc::OnSegmentContourtracing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
	IppIntImage imgLabel;
...
void CImageToolDoc::OnBinarymophologyErosion()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
	IppByteImage imgDst;
...
void CImageToolDoc::OnBinarymophologyDilation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
	IppByteImage imgDst;
	IppMorpholgyDilation(img, imgDst);
	CONVERT_IMAGE_TO_DIB(imgDst, dib)
...
void CImageToolDoc::OnBinarymophologyOpening()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
		IppByteImage imgDst;
...
void CImageToolDoc::OnBinarymophologyClosing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
	IppByteImage imgDst;
...
void CImageToolDoc::OnGrayscalemophologyErosio()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
	IppByteImage imgDst;
...
void CImageToolDoc::OnGrayscalemophologyDilation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
		IppByteImage imgDst;
	IppMorpholgyGaryDilation(img, imgDst);
	CONVERT_IMAGE_TO_DIB(imgDst, dib)
...
void CImageToolDoc::OnGrayscalemophologyOpening()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
		IppByteImage imgDst;
...
void CImageToolDoc::OnGrayscalemophologyClosing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CONVERT_DIB_TO_BYTEIMAGE(m_Dib, img)
		IppByteImage imgDst;
	IppMorpholgyGaryClosing(img, imgDst);
	CONVERT_IMAGE_TO_DIB(imgDst, dib)
...
void CImageToolDoc::OnSegmentFourierdescriptor()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFourierDescDlg dlg;
...
void CImageToolDoc::OnSegmentTemplatematching()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
