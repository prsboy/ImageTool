...
public:
	...
	afx_msg void OnColorUpdateimageinverse(CCmdUI *pCmdU);
	afx_msg void OnColorConvertograyscale();
	afx_msg void OnUpdateColorConvertograyscale(CCmdUI *pCmdUI);
	afx_msg void OnRgbtoyuvRgb();
	afx_msg void OnUpdateRgbtoyuvRgb(CCmdUI *pCmdUI);
	afx_msg void OnRgbtoyuvHsi();
	afx_msg void OnUpdateRgbtoyuvHsi(CCmdUI *pCmdUI);
	afx_msg void OnRgbtoyuvYuv();
	afx_msg void OnUpdateRgbtoyuvYuv(CCmdUI *pCmdUI);
	afx_msg void OnColorcombineRgb();
	afx_msg void OnColorcombineHsi();
	afx_msg void OnColorcombineYuv();
	afx_msg void OnColorColoredge();
	afx_msg void OnUpdateColorColoredge(CCmdUI *pCmdUI);
	afx_msg void OnColorColorhisto();
	afx_msg void OnSegmentBinarization();
	afx_msg void OnSegmentLabeling();
	afx_msg void OnSegmentContourtracing();
	afx_msg void OnBinarymophologyErosion();
	afx_msg void OnBinarymophologyDilation();
	afx_msg void OnBinarymophologyOpening();
	afx_msg void OnBinarymophologyClosing();
	afx_msg void OnGrayscalemophologyErosio();
	afx_msg void OnGrayscalemophologyDilation();
	afx_msg void OnGrayscalemophologyOpening();
	afx_msg void OnGrayscalemophologyClosing();
	afx_msg void OnSegmentFourierdescriptor();
	afx_msg void OnSegmentTemplatematching();
};
